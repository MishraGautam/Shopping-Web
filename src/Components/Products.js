...
const Products=()=>{
    ...
    <div className="nav flex-column nav-pills side" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a className="nav-link" id="v-pills-gautam-tab" data-toggle="pill" href="#v-pills-gautam" role="tab" aria-controls="v-pills-home" aria-selected="false">Home & Kitchen</a>
    ...
    <div className="tab-content" id="v-pills-tabContent">
      ...
      <div className="tab-pane fade" id="v-pills-gautam" role="tabpanel" aria-labelledby="v-pills-gautam-tab">
      <div className='container'>
        <div className='products'>
